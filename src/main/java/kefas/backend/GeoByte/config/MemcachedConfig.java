...
public class MemcachedConfig extends AbstractSSMConfiguration {
    ...
    @Bean    public MemcachedClient memcachedClient() {
    ...
    @Bean    @Override    public CacheFactory defaultMemcachedClient() {
    ...
    @Bean    public CacheManagerCustomizer<ExtendedSSMCacheManager> cacheManagerCustomizer(){
        return cacheManager -> {
            Cache cache = null;
            try {
